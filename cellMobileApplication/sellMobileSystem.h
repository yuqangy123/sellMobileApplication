...
public:
	...
	bool requestOrderQuery(HWND objHwnd, const char* out_trade_no = "", const char* order_no = "");
	bool requestRefundOrder(HWND objHwnd, const char* order_no, const char* out_trade_no, const char* out_refund_no, const char* ctotalfee, const char* cfee);
	bool requestRefundQuery(HWND objHwnd, const char* order_no, const char* out_trade_no, const char* refund_no);
